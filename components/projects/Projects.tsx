      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
        {projects.map((project, idx) => (
          <motion.div
            ...
            className="group flex flex-col justify-between w-full h-full rounded-2xl border border-dashed border-neutral-300 dark:border-neutral-800 bg-neutral-50/40 dark:bg-neutral-900/20 p-4 sm:p-5 transition-all duration-300 hover:border-neutral-400 dark:hover:border-neutral-700 shadow-2xs"
          >
            <div>
              {/* Preview Banner */}
              <a
              ...
              <div className="flex justify-between items-start mt-4 gap-2">
                ...
                <span className="inline-flex items-center gap-1 text-[11px] font-medium text-emerald-600 dark:text-emerald-400 shrink-0 mt-0.5 font-mono">
            ...
            {/* Footer: Tags & Actions */}
            <div className="mt-5 pt-3 border-t border-dashed border-neutral-200 dark:border-neutral-800/80 flex items-start sm:items-center justify-between gap-3">
              <div className="flex flex-wrap gap-1.5 items-center">
                {(project.mainTags || project.tags).map((tag) => (
                  <span
                    key={tag}
                    className="text-[10px] sm:text-[11px] px-2 py-0.5 border border-dashed border-neutral-300 dark:border-neutral-700 bg-black/5 dark:bg-white/5 rounded text-neutral-700 dark:text-neutral-300 font-mono"
                  >
                    {tag}
                  </span>
                ))}
              ...
              <div className="flex items-center gap-1 shrink-0">
                {project.liveLink && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="size-7 sm:size-8 rounded flex items-center justify-center text-neutral-500 hover:text-foreground hover:bg-black/5 dark:hover:bg-white/5 transition-colors"
